...
def _print_startup_summary():
    ...
    lines = [
        ...
        f"  Entry rules  : LOWS ONLY (2026-08-13)  |  same-day ≤ {MAX_HOURS_TO_RESOLUTION:.0f}h to local day end  |  direction agrees  |  margin ≥ {FORECAST_MARGIN_F:g}°F  |  price {MIN_ENTRY_PRICE:.2f}–{MAX_ENTRY_PRICE:.2f}  |  trapped-min guard  (highs logged, non-binding)",
